...
%% %%
figure
for kk = 1:length(intensity_linescan)
%     plot(intensity_linescan(kk).int, 'color', [0.8 0.8 0.8])
    plot(intensity_linescan(kk).int, 'k')
    hold on
end
av_int = nanmean(intensity_linescan_matrix, 2);
plot(av_int, 'g', 'linewidth', 3)

figure
plot(av_int, 'g', 'linewidth', 3); hold on
clear
%% %%
